...
class User(db.Model, UserMixin):
    ...
    # lazy refers to a 0 or many relationship
    # backref is the key to connecting tables together:
    # 'drone_1.owner' grabs all user info for drone_1
...
drones_schema = DroneSchema(many=True)
    ...
    # take a python class object like <Drone x4530897983432423>
